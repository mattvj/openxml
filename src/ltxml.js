...
(function (root) {
  ...
  function defineLtxml(root, Enumerable) {  //ignore jslints
    ...
    var parseXml, Functions, Ltxml, addContentThatCanContainEntities,
      ...
      ancestors, ancestorsAndSelf, attributes, descendantNodes, descendantNodesAndSelf, descendants, descendantsAndSelf,
      elements,
    ...
    Ltxml.XNode.prototype.deepEquals = function (other) {
      ...
      if (nodes1
          ...
          .any(function (z) {
            return !z.node1.deepEquals(z.node2);
          })) {
        return false;
      }
      return true;
    ...
    Ltxml.XContainer.prototype.add = function () {
      ...
      addContent(this,
        function (c) {
          nodesToInsert.push(c);
        },
        function (a) {
          attributesToInsert.push(a);
        },
        args);
    ...
    Ltxml.XContainer.prototype.descendantNodes = function () {
      ...
      result = [];
      descendantNodesHelper(this, function (e) {
        result.push(e);
      });
      return Enumerable.from(result);
    };
    ...
    Ltxml.XContainer.prototype.descendants = function (xname) {
      ...
      result = [];
      eagarDescendantHelper(this, xname, function (e) {
        result.push(e);
      });
      return Enumerable.from(result);
    };
    ...
    Ltxml.XContainer.prototype.elements = function (xname) {
      ...
      if (xname) {
        returnValue = Enumerable
          .from(this.nodesArray)
          .where(function (e) {
            return e.nodeType === 'Element' && e.name === xname;
          });
      }
      else {
        returnValue = Enumerable
      ...
      if (indent) {
        ...
        if (mixed_content) {
          ...
          Enumerable.from(attributesToUse)
            ...
            .take(middle_take)
            .forEach(function (a) {
              o.a(attribute_indent_spaces).a(a).a("\n");
            });
          o.a(attribute_indent_spaces);
          attributesToUse[attributesToUse.length - 1].serialize(o);
          o.a(">");
    ...
    Ltxml.XElement.prototype.descendantNodesAndSelf = function () {
      ...
      result = [];
      result.push(this);
      descendantNodesAndSelfHelper(this, function (e) {
        result.push(e);
      });
      return Enumerable.from(result);
    };
